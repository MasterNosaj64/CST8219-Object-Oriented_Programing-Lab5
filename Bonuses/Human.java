 ...
 */
	...
	Human(Scanner input) {
		...
		in=input;
		// How many Scanner objects exist in memory at this point?
		//Answer:1
	}
/**
 ...
 */
	...
	public boolean takeTurn() {
		...
		do {
			System.out.println(
					name + ", it's your turn (Enter R for Rock, P for Paper, S for Scissors, L for Lizzard, K for Spock or Q to quit):");
